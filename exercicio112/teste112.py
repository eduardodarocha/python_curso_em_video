...
# import exercicio112.utilidadesCeV.dado
# import exercicio112.utilidadesCeV.moeda

# p = exercicio112.utilidadesCeV.dado.leiaDinheiro('Digite o preço: R$')
# exercicio112.utilidadesCeV.moeda.resumo(p, 35, 22)